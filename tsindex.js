...
function CheckNumIsNegPos(numIsNegPos) {
    if (numIsNegPos >= 0) {
...
function CheckNumIsEvenOdd(num) {
    if (num % 2 === 0) {
...
function checkVowelOrCnstant(str) {
...
function CheckAlphaDigitOrSpecialChar(str) {
    if (str >= "A" && str <= "Z" || str >= "a" && str <= "z") {
...
function chechCharUpperOrLower(str) {
...
function CheckTriangleValid(side1, side2, side3) {
...
function CheckThreeTriangle(side1, side2, side3) {
...
function ProphitLoss(salePrice, costPrice) {
    var profit;
    var loss;
...
var CheistryMarks = Number(prompt("Enter Cheistry Marks"));
var MathMarks = Number(prompt("Enter Math Marks"));
var BioMarks = Number(prompt("Enter Bio Marks"));
var ComputerMarks = Number(prompt("Enter Computer Marks"));
var grade;
var TotalMarks = PhysicsMarks + CheistryMarks + MathMarks + BioMarks + ComputerMarks;
...
var getUnit = Number(prompt("Enter Unit"));
var amt = 0;
